...
echo "\n" . esc_html( wc_strtoupper( esc_html__( 'Billing address', 'woocommerce-checkout-field-editor' ) ) ) . "\n\n";
...
if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) {
	...
	if ( $shipping ) {
		echo "\n" . esc_html( wc_strtoupper( esc_html__( 'Shipping address', 'woocommerce-checkout-field-editor' ) ) ) . "\n\n";
		echo preg_replace( '#<br\s*/?>#i', "\n", $shipping ) . "\n"; // WPCS: XSS ok.
	}
